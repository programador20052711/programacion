...
write("para esa futbolista, que algun dia cumplira toda sus metas ",align="center",font=("arial",24, "bold"))
penup()
goto(-30,-250)# ajuste de la posicion abajo del otro texto
color("purple")
write("eres una de las personas maravillosas que tengo alrededo ",align="center",font=("arial",24, "bold"))
goto(-30,-300)# ajuste de la posicion abajo del otro texto
color("purple")
write("nunca dudes de lo que puedes hacer, actualmente y en el futuro. ",align="center",font=("arial",24, "bold"))
